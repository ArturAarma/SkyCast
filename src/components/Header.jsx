...
return (
    ...
    <div className="flex items-center space-x-2">
            ...
            className="bg-blue-800 transition-all duration-300 w-[200px] md:w-[250] focus:md:w-[300px] dark:bg-gray-800 p-2 rounded-lg focus:outline-none text-white"
            value={searchCity}
            onChange={(e) => setSearchCity(e.target.value)}
            />

        <button 
        className="bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-900 transition-transform transform active:scale-110 duration-300" 
