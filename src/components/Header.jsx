...
return (
    ...
    <button
      className="px-4 py-2 text-sm font-medium text-bladck bg-white dark:bg-gray-900 dark:text-white rounded-lg transition-all duration-200 border-2 border-white"
